...
Please check the [event page](https://july4.grandparkla.org/) for the latest details on recommended parking and street closures. This page will be updated on a regular basis. Note that Lot 10 on N Broadway will be closed for this event.
